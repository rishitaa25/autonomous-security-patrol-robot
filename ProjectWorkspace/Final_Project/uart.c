...
//{
//    char byte_received;
//    static char last_cmd = '\0';  // ADD THIS
//
//    if (UART1_MIS_R & 0x10)
//    {
...
//        byte_received = (char)(UART1_DR_R & 0xFF);
//
//        if(byte_received != last_cmd)  // ADD THIS CHECK
//        {
//            switch(byte_received)
//            {
//                case 'm': uart_sendStr("\r[START]\r\n");  break;
//                case 'w': uart_sendStr("\r[FORWARD]\r\n");  break;
//                case 's': uart_sendStr("\r[BACKWARD]\r\n"); break;
//                case 'a': uart_sendStr("\r[LEFT]\r\n");     break;
//                case 'd': uart_sendStr("\r[RIGHT]\r\n");    break;
//                case 'k': uart_sendStr("\r[SCAN]\r\n");     break;
//                case '\r': uart_sendStr("\r\n");             break;
//                default: break;
//            }
//            last_cmd = byte_received;  // ADD THIS
//        }
//
//        if(byte_received == 's')
//        {
