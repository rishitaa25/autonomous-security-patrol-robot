...
#filename = 'dataCleanup.txt'
#filename = 'cleaned_data.txt'
#filename = 'unclean_data_2.txt'
#filename = 'unclean_data_3.txt'
#filename = 'auto_cleaned_2.txt'
#filename = 'auto_cleaned_3.txt'
filename = 'man_cleaned_data_2.txt'
#filename = 'man_cleaned_data_3.txt'
...
for line in file_data: 
    ...
    distance.append(float(data[1])/100.0)      # Column 1 holds the distance that was measured at a given angle       
...
ax.set_title("Manual Cleaned Data", size=14, y=1.0, pad=-24) 
